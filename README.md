...
Initial testing has shown that the proposed invertible Bloom filter is highly capable of key/value pair differences utilizing Bloom filters with a capacity equal to the number of differences. 
