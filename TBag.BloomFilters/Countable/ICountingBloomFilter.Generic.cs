...
namespace TBag.BloomFilters.Countable
{
    ...
    interface ICountingBloomFilter<TEntity, TId, TCount> 
       where TId : struct
        where TCount : struct
    {
        #region Properties
        ...
        /// The configuration
        /// </summary>
        IEntityCountingBloomFilterConfiguration<TEntity, TId, int, TCount> Configuration { get; }
        ...
        void Add(ICountingBloomFilter<TEntity, TId, TCount> bloomFilter);
        ...
        void Add(ICountingBloomFilterData<TId, TCount> bloomFilterData);
        ...
        ICountingBloomFilter<TEntity, TId, TCount> Fold(uint factor, bool destructive = false);
        ...
        void Rehydrate(ICountingBloomFilterData<TId, TCount> data);
        ...
        /// <param name="modifiedEntities">Entities in both filters, but with a different value</param>
        /// <returns><c>true</c> when the decode was successful, otherwise <c>false</c></returns>
        bool? SubtractAndDecode(ICountingBloomFilter<TEntity, TId, TCount> filter, HashSet<TId> listA,
            HashSet<TId> listB,
            HashSet<TId> modifiedEntities);
        ...
        /// </summary>
        ICountingBloomFilter<TEntity, TId, TCount> Compress(bool inPlace = false);
        ...
        void Intersect(ICountingBloomFilter<TEntity, TId, TCount> bloomFilter);
        ...
        /// <remarks>The result is the shared entities between the two Bloom filters</remarks>
        void Intersect(ICountingBloomFilterData<TId, TCount> otherFilterData);
        #endregion
    }
}
