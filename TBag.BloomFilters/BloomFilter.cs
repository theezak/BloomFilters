...
namespace TBag.BloomFilters
{
    ...
    namespace BloomFilter
    {
        ...
        public class BloomFilter<T>
        {
            ...
            public BloomFilter(int capacity, Func<T,int> hashFunction) : this(capacity, bestErrorRate(capacity), hashFunction) { }
            ...
            /// <param name="errorRate">The accepable false-positive rate (e.g., 0.01F = 1%)</param>
            /// <param name="hashFunction">The function to hash the input values. Do not use GetHashCode(). If it is null, and T is string or int a hash function will be provided for you.</param>
            public BloomFilter(int capacity, float errorRate, Func<T,int> hashFunction) : this(capacity, errorRate, hashFunction, bestM(capacity, errorRate), bestK(capacity, errorRate)) { }
            ...
            private readonly Func<T,int> getHashSecondary;
