    ...
    {       
            ...
            where TCount : struct
        {
            ...
            return estimator.StrataEstimator.Decode(otherEstimatorData.StrataEstimator, configuration) + 
                (ulong)(estimator.BitMinwiseEstimator.Capacity - (estimator.BitMinwiseEstimator.Similarity(otherEstimatorData.BitMinwiseEstimator) * estimator.BitMinwiseEstimator.Capacity));
