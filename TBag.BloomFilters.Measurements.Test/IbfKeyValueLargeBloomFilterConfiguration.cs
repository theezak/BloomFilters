namespace TBag.BloomFilters.Measurements.Test
{
    ...
    /// </summary>
    internal class IbfKeyValueLargeBloomFilterConfiguration : ReverseConfigurationBase<TestEntity, int>
    {
        private readonly IMurmurHash _murmurHash = new Murmur3();

        public IbfKeyValueLargeBloomFilterConfiguration() : base(new IntCountConfiguration())
        {}
